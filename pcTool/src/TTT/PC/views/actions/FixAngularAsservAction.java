...
public class FixAngularAsservAction extends AbstractAction {
	static final long serialVersionUID = -6945893446370275518L;
	private ConnexionController controller;

	public FixAngularAsservAction(ConnexionController controller){
		super();
	...
	public void actionPerformed(ActionEvent e){
		this.controller.sendFixAngularAsserv();
	}
}
